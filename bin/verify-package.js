...
for (const file of ["LICENSE", "public/licenses/NotoSansMono-OFL.txt", ".next/BUILD_ID", ".next/required-server-files.json", ".next/server", ".next/static"]) {
...
requireCondition(fs.readFileSync(path.join(root, "LICENSE"), "utf8").includes("Copyright (c) 2026 agegr"), "Upstream copyright notice must be retained.");
