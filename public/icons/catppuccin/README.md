...
- `latte/` is used in Pi Web Space's light theme.
- `mocha/` is used in Pi Web Space's dark theme.
- Pi Web Space uses the SVG alpha channel as a mask and applies `var(--text-dim)`,
