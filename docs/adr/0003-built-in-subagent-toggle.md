...
Pi Web Space's integrated sub-agent implementation is an inline, hidden extension.
...
When the integrated extension is disabled, Pi Web Space does not suppress the legacy
