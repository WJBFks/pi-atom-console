...
Pi Web Space's interface uses a small internal i18n layer. It is intentionally kept
...
/** Pi Web Space Japanese language package. */
...
Pi Web Space is a user-facing web interface. Internationalization is therefore an
...
support should lower the barrier to using Pi Web Space, not be treated as a measure
