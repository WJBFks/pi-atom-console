...
bits during installation, including published/npm-installed Pi Web Space packages.

Pi Web Space pins node-pty to `1.2.0-beta.15`, which includes Linux x64 and ARM64
...
Restart Pi Web Space after repair.
