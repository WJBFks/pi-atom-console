...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.generalDescription": "Choose how Pi Web Space looks and which language it uses.",
    ...
    "agents.close": "Close",
    "agents.builtInTitle": "Enable Pi Web Space built-in sub-agents",
    "agents.builtInDescription": "Provides Pi Web Space's integrated Agent tools and disables a conflicting pi-subagents extension.",
    ...
    "appUpdate.releaseNotes": "Upstream Pi Web v{version} is available. View release notes",
    ...
    "sidebar.selectProject": "New workspace",
    ...
    "workspace.useDefaultName": "Use default name",
    "workspace.saveName": "Save",
    "directoryPicker.selectDirectory": "New workspace",
    ...
    "directoryPicker.selectThisFolder": "Continue",
    ...
    "sidebar.showSessions": "Show sessions",
