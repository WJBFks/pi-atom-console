...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.general": "一般",
    "settings.generalDescription": "選擇 Pi Web Space 的外觀與介面語言。",
    ...
    "agents.close": "關閉",
    "agents.builtInTitle": "啟用 Pi Web Space 內建子代理",
    "agents.builtInDescription": "提供 Pi Web Space 整合的 Agent 工具，並停用發生衝突的 pi-subagents 擴充功能。",
    ...
    "appUpdate.releaseNotes": "上游 Pi Web v{version} 已推出，查看版本資訊",
    "sidebar.hide": "隱藏側邊欄",
    "sidebar.show": "顯示側邊欄",
    "theme.light": "主題：淺色",
    "theme.dark": "主題：深色",
    ...
    "workspace.useDefaultName": "使用預設名稱",
    "workspace.saveName": "儲存",
    "directoryPicker.selectDirectory": "新增工作區",
    ...
    "directoryPicker.selectThisFolder": "確定",
    ...
    "sidebar.archive": "封存",
    "sidebar.restore": "還原",
    "sidebar.showArchived": "顯示已封存工作階段",
    "sidebar.showSessions": "顯示工作階段",
